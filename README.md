# boss-net and Government [![Test site build](https://github.com/boss-net/boss-net.github.com/actions/workflows/build.yml/badge.svg)](https://github.com/boss-net/boss-net.github.com/actions/workflows/build.yml)
...
Submit [issues](https://github.com/boss-net/boss-net.github.com/issues/new) and [pull requests](https://github.com/boss-net/boss-net.github.com/compare/) for stories, site ideas or copy edits.
...
```bash
git clone https://github.com/boss-net/boss-net.github.com.git
cd boss-net.github.com
script/bootstrap
script/server
```
